# Generated by Django 5.2.5 on 2025-08-20 15:28
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['post', 'user'], name='posts_like_post_id_d262ec_idx'), models.Index(fields=['created_at'], name='posts_like_created_1d3e7e_idx')],
